...
class DBHelper
{
    ...
    func createTable() {
        let createTableString = "CREATE TABLE IF NOT EXISTS person(Id INTEGER PRIMARY KEY,name TEXT,email TEXT);"
    ...
    func insert(id:Int, name:String, email:String)
    {
        ...
        let insertStatementString = "INSERT INTO person (Id, name, email) VALUES (?, ?, ?);"
    ...
    func read() -> [Person] {
        ...
        if sqlite3_prepare_v2(db, queryStatementString, -1, &queryStatement, nil) == SQLITE_OK {
            while sqlite3_step(queryStatement) == SQLITE_ROW {
                ...
                psns.append(Person(id: Int(id), name: name, email: email))
                print("Query Result:")
                print("\(id) | \(name) | \(email)")
            }
        } else {
